...
KNOWN_KEYSTONES: set[str] = {
    ...
    # Projectile / elemental keystones previously missing from this set
    "point blank", "avatar of fire",
}
...
KEYSTONE_BUILD_REQUIREMENTS: list[dict] = [
    ...
    },
    {
        ...
        "required_keywords": ["bow", "projectile", "ranged"],
        "fields": ["weapon_type", "attack_style"],
        "reason": "only benefits close-range projectile attacks — useless on melee or spell builds",
    },
    {
        "keystone": "avatar of fire",
        "required_keywords": ["fire"],
        "fields": ["damage_type"],
        "reason": "converts all damage to fire and prevents non-fire damage — only valid on dedicated fire builds",
    },
]
